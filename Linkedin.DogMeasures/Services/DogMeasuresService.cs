...
namespace Linkedin.DogMeasures.Services
{
    public class DogMeasuresService
    {
        ...
        public DogWeightInfo CheckDogIdealWeight(string breed, decimal weight)
        {
            ...
            var dog = _dogInfo.SingleOrDefault(d => d.Breed.Equals(
                breed, StringComparison.InvariantCultureIgnoreCase));
            if (dog == null)
            {
            ...
            if (weight > dog.RecommendedMaxWeight)
            {
                ...
                return new DogWeightInfo {
                    DeviationType = DogWeightInfo.WeightDeviationType.Overweight,
                    Message = $"Tu perro se pasa del peso ideal por {deviation} KG.",
            ...
            return new DogWeightInfo {
                Message = "¡Tu perro está en su peso ideal! ¡Enhorabuena!",
                DeviationType = DogWeightInfo.WeightDeviationType.InRange,
                WeightDeviation = 0m
            };
        }
    }
